...
![image](https://raw.githubusercontent.com/ivaben/Ivana-dashboard.github.io/master/img/ED_css.PNG)
...
![image](https://raw.githubusercontent.com/ivaben/Ivana-dashboard.github.io/master/img/data_points.PNG)
...
class KNN:
    ...
    def _predict(self, x):
        # calculate all of distances and define this in separate method 
        # (call it:euclidean_distance)
        # calculate the distance of this one sample(x) to all the training samples 
        # using list comprehensions
        distances = [euclidean_distance(x, x_train) for x_train in self.X_train]
        # get the k samples of the nearest neighbors and the labels of 
        # the nearest neighbors and
        # sort out our distances
        k_neigbor_samples = np.argsort(distances) [:self.k] # array from 
        # beggining until self.k
